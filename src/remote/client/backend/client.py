...
from remote.client.backend.game import Game
from remote.client.backend.network_interface import (
    NetworkInterface,
    NetworkInterfaceConnectionError,
)
...
def parseOptions():
    ...
    parser.add_argument(
        '-u', '--username', action='store', type=str, dest='username', default="", help='Username'
    )
    parser.add_argument(
        '-o',
        '--output-path',
