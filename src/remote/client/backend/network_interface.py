...
from remote.common.error import *
...
class NetworkInterface(pb.Referenceable):
    def __init__(
        self, *, client, server: str = 'al-hockey.is.tuebingen.mpg.de', port: str = '33000'
    ):
        self.client = client
    ...
    def connect(self) -> None:
        d = self.factory.login(
            credentials.UsernamePassword(
                self.client.username.encode('utf-8'), self.client.password.encode('utf-8')
            ),
            client=self,
        )
